...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `runreceipt` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in runreceipt.
